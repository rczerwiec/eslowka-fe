...
const SideBar = () => {
  ...
  return (
    <div className="relative flex flex-col justify-between top-0 left-0 bg-main w-60  ax-lg:hidden shadow-lg">
      <div className="flex flex-col justify-between">
        ...
        <div className="absolute bottom-14 left-12 mx-auto text-center text-white text-xs py-4 border-t border-neutral-800">
          <div className="font-semibold">Esłówka</div>
          <div>Wersja: 1.0.12 alpha</div>
        </div>
      </div>
    </div>
  );
