...
const StatusBox = () => {
    return(
        <div className="flex flex-col items-center w-1/4 shadow-lg mx-2 rounded-xl text-sm font-thin font-inter bg-white z-10 h-40 border-secondary border-y-2 border-x-2 max-lg:hidden">
