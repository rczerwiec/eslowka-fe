...
const FoldersPage = () => {
  ...
  <div className="w-full max-w-5xl mx-auto mt-6">
    {Array.isArray(folderRender?.renderedFolders) &&
    folderRender?.renderedFolders.length > 0 ? (
      <div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4"
        style={{
          maxWidth: "calc(100% - 20px)", // Dopasowanie szerokości do ilustracji
          overflowY: "auto", // Przewijanie pionowe
          maxHeight: "calc(100vh - 200px)", // Ograniczenie wysokości
        }}
      >
